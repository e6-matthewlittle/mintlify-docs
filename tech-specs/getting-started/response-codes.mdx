...
route: /tech-specs/getting-started/response-codes
...
When a call is successful, you see the entire data structure returned. In the event of an unsuccessful call, you receive a response code and a text message indicating what issue occurred.

Tritium® provides detailed response codes that go far beyond standard HTTP response codes. With the exception of Success and Failed, all major codes are six digits in length.
