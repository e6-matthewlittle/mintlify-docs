...
Episode Six (E6) accepts certain headers as part of the exposure of RESTful APIs from the E6 Platform. These headers enable basic processing of RESTful API payload, secure access, and the ability to enable better debugging.
